...
FACES_SAVE_DIR = r"data\faces"
EMBEDDING_SAVE_DIR = r"embeddings"
CLUSTER_SAVE_DIR = r"saved_cluster"
PCA_SAVE_DIR = r"pca_model"
...
def cluster_faces_DBSCAN(faces_dir, save_cluster_dir, use_pca):
    clusterer = DBSCANClusterer(faces_dir, save_cluster_dir, eps=0.13, use_pca=use_pca) # 0.16 was good
    clusterer.fit_map_clusterer()
    clusterer.save_clusters_to_folder(r'clusters')

def cluster_faces_HDBSCAN(faces_dir, save_cluster_dir, use_pca):
    clusterer = HDBSCANClusterer(faces_dir, save_cluster_dir, use_pca=use_pca)
    clusterer.fit_map_clusterer()
    clusterer.save_clusters_to_folder(r'clusters')
...
def main():
    ...
    cluster_faces_HDBSCAN(FACES_SAVE_DIR, CLUSTER_SAVE_DIR, use_pca=True)
