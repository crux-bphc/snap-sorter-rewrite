...
FACES_SAVE_DIR = r"data\faces_D2"
EMBEDDING_SAVE_DIR = r"embeddings\embeddings_D2"
CLUSTER_SAVE_DIR = r"saved_cluster\cluster_D2"
PCA_SAVE_DIR = r"pca_model\pca_D2"
CLUSTER_LOCAL_SAVE = r'clusters\clusters_D2'
